        ...
        return [
            {
                ...
                fn: async (req, res, _params, parsedUrl)=>{
                    ...
                    try {
                        ...
                        sendResponse(req.originalRequest, res.originalResponse, paramsResult.href, cacheEntry.value.extension, cacheEntry.value.buffer, paramsResult.isStatic, cacheEntry.isMiss ? 'MISS' : cacheEntry.isStale ? 'STALE' : 'HIT');
                    } catch (err) {
