...
async function getBaseWebpackConfig(dir, { buildId , config , dev =false , isServer =false , isEdgeRuntime =false , pagesDir , target ='server' , reactProductionProfiling =false , entrypoints , rewrites , isDevFallback =false , runWebpackSpan  }) {
    var ref63, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, ref14, ref15;
    ...
    const hasReact18 = Boolean(reactDomVersion) && (_semver.default.gte(reactDomVersion, '18.0.0') || ((ref63 = _semver.default.coerce(reactDomVersion)) === null || ref63 === void 0 ? void 0 : ref63.version) === '18.0.0');
        ...
        plugins: [
          ...
          `
            ...
            !dev && !isServer && new _telemetryPlugin.TelemetryPlugin(new Map([
                ...
                [
                    'swcRelay',
                    !!((ref3 = config.compiler) === null || ref3 === void 0 ? void 0 : ref3.relay)
                ],
                [
                    'swcStyledComponents',
                    !!((ref4 = config.compiler) === null || ref4 === void 0 ? void 0 : ref4.styledComponents)
                ],
                [
                    'swcReactRemoveProperties',
                    !!((ref5 = config.compiler) === null || ref5 === void 0 ? void 0 : ref5.reactRemoveProperties), 
                ],
                [
                    'swcExperimentalDecorators',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref6 = jsConfig.compilerOptions) === null || ref6 === void 0 ? void 0 : ref6.experimentalDecorators), 
                ],
                [
                    'swcRemoveConsole',
                    !!((ref7 = config.compiler) === null || ref7 === void 0 ? void 0 : ref7.removeConsole)
                ],
                [
                    'swcImportSource',
                    !!(jsConfig === null || jsConfig === void 0 ? void 0 : (ref8 = jsConfig.compilerOptions) === null || ref8 === void 0 ? void 0 : ref8.jsxImportSource)
                ], 
            ])), 
        ].filter(Boolean)
    };
    ...
    if (resolvedBaseUrl) {
        var ref, ref61;
        (ref = webpackConfig.resolve) === null || ref === void 0 ? void 0 : (ref61 = ref.modules) === null || ref61 === void 0 ? void 0 : ref61.push(resolvedBaseUrl);
    }
    if ((jsConfig === null || jsConfig === void 0 ? void 0 : (ref9 = jsConfig.compilerOptions) === null || ref9 === void 0 ? void 0 : ref9.paths) && resolvedBaseUrl) {
        var ref, ref114;
        (ref = webpackConfig.resolve) === null || ref === void 0 ? void 0 : (ref114 = ref.plugins) === null || ref114 === void 0 ? void 0 : ref114.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref10 = config.compiler) === null || ref10 === void 0 ? void 0 : ref10.removeConsole,
        reactRemoveProperties: (ref11 = config.compiler) === null || ref11 === void 0 ? void 0 : ref11.reactRemoveProperties,
        styledComponents: (ref12 = config.compiler) === null || ref12 === void 0 ? void 0 : ref12.styledComponents,
        relay: (ref13 = config.compiler) === null || ref13 === void 0 ? void 0 : ref13.relay
    });
    const cache = {
        type: 'filesystem',
        // Includes:
        ...
        version: `${"12.0.11-canary.15"}|${configVars}`,
    ...
    if (typeof config.webpack === 'function') {
        ...
        } else if (typeof ((ref167 = webpack5Config.experiments) === null || ref167 === void 0 ? void 0 : ref167.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (config.experimental.craCompat && ((ref14 = webpackConfig.module) === null || ref14 === void 0 ? void 0 : ref14.rules) && webpackConfig.plugins) {
    ...
    var ref220;
    const hasUserCssConfig = (ref220 = (ref15 = webpackConfig.module) === null || ref15 === void 0 ? void 0 : ref15.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include)
    )) !== null && ref220 !== void 0 ? ref220 : false;
    if (hasUserCssConfig) {
        var ref, ref221, ref222, ref223;
        ...
        if ((ref221 = webpackConfig.plugins) === null || ref221 === void 0 ? void 0 : ref221.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref222 = webpackConfig.optimization) === null || ref222 === void 0 ? void 0 : (ref223 = ref222.minimizer) === null || ref223 === void 0 ? void 0 : ref223.length) {
