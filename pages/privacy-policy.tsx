...
export default function ContactPage() {
  return (
    <>
      <title>Datenschutz - neptoon.ch</title>
      <meta name="description" content="Datenschutz" />
      <meta property="og:title" content="Datenschutz - neptoon.ch" />
      <meta property="og:description" content="Datenschutz" />
      <meta property="og:url" content="https://neptoon.ch/privacy-policy" />
      ...
      <Page title="Datenschutz">
        <PrivacyPolicyContainer>
          <RichText>
            ...
            <p>
              <p>
                Der Provider dieser Website erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind: Browsertyp und Browserversion Verwendetes Betriebssystem Referrer URL Hostname des zugreifenden Rechners Zeitpunkt der Serveranfrage.
            ...
            <p>
              <p>
                Diese Website kann Google Maps, Microsoft Bing Maps und Openstreetmaps zur Einbettung von Karten, Google Invisible reCAPTCHA zum Schutz vor Bots und Spam und YouTube zur Einbettung von Videos nutzen. Diese Dienste der amerikanischen Google LLC verwenden u.a. Cookies, wodurch Daten an Google in die USA übertragen werden, wobei wir davon ausgehen, dass in diesem Zusammenhang allein durch die Nutzung unserer Website kein personenbezogenes Tracking stattfindet. Google hat sich verpflichtet, einen angemessenen Datenschutz gemäß dem US-amerikanisch-europäischen und dem US-amerikanisch-schweizerischen Privacy Shield zu gewährleisten. Weitere Informationen finden Sie in den Datenschutzbestimmungen von Google.
                Diese Dienste von Microsoft verwenden u.a. Cookies, wodurch Daten an Microsoft in die USA übertragen werden, wobei wir davon ausgehen, dass in diesem Zusammenhang allein durch die Nutzung unserer Website kein personenbezogenes Tracking stattfindet. Microsoft hat sich verpflichtet, einen angemessenen Datenschutz gemäß dem US-amerikanisch-europäischen und dem US-amerikanisch-schweizerischen Privacy Shield zu gewährleisten. Weitere Informationen finden Sie in den Datenschutzbestimmungen von Microsoft.
                Diese Dienste von OpenStreetMap Foundation verwenden u.a. Cookies, wodurch Daten an Openstreetmaps in die UK übertragen werden, wobei wir davon ausgehen, dass in diesem Zusammenhang allein durch die Nutzung unserer Website kein personenbezogenes Tracking stattfindet. OpenStreetMap Foundation hat sich verpflichtet, einen angemessenen Datenschutz gemäß dem UK-englisch-europäischen und dem UK-englisch-schweizerischen Privacy Shield zu gewährleisten. Weitere Informationen finden Sie in den Datenschutzbestimmungen von OpenStreetMap Foundation.</p>
            </p>
          </RichText>
        </PrivacyPolicyContainer>
      </Page>
