  ...
  async function onSubmit(payload: EmailPayload) {
    try {
      const res = await fetch('/api/sendEmail', {
        ...
        body: JSON.stringify({ subject: 'Email Kontakt', ...payload }),
      });
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <InputGroup>
          <InputStack>
            ...
            <Input placeholder="Dein Name" id="name" disabled={isDisabled} {...register('name', { required: true })} />
          </InputStack>
          <InputStack>
            {errors.email && <ErrorMessage>Email is required</ErrorMessage>}
            <Input placeholder="Deine Email" id="email" disabled={isDisabled} {...register('email', { required: true })} />
          </InputStack>
        </InputGroup>
        <InputStack>
